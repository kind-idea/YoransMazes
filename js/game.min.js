...
d||a(t,s);"$"!==d&&"*"!==d&&"!"!==d||n(t,s,1);if("H"===d||"I"===d||"J"===d||"K"===d)"H"===d&&(u=0),"I"===d&&(u=1),"J"===d&&(u=2),"K"===d&&(u=3),m(t,s,u),c(t,s,u);if(!0===toggles.decor&&!0===useWebGL){if("A"===d||"B"===d||"C"===d||"D"===d)"A"===d&&(u=0),"B"===d&&(u=1),"C"===d&&(u=2),"D"===d&&(u=3),f(t,s,u);"%"===d&&g(t,s,0);var v;if("1"===d||"2"===d||"3"===d||"4"===d||"5"===d||"6"===d||"7"===d)u=Number(d)-1,p(t,s,u),g(t,s,0);else if("U"===d||"V"===d||"W"===d)"U"===d&&(v=0),"V"===d&&(v=1),"W"===d&&
(v=2),q(t,s,v,"vert"),g(t,s,0);else if("X"===d||"Y"===d||"Z"===d)"X"===d&&(v=0),"Y"===d&&(v=1),"Z"===d&&(v=2),q(t,s,v,"horiz"),g(t,s,0);else if(":"===d||"-"===d||"?"===d)":"===d&&(v=0),"-"===d&&(v=1),"?"===d&&(v=2),h(t,s,v),g(t,s,0)}}!1===soko&&(!0===allPressed()?(doorOpen.visible=!0,doorClose.visible=!1):(doorOpen.visible=!1,doorClose.visible=!0));addedCon=new THREE.Mesh(r,conMat);addedWat=new THREE.Mesh(l,waterMat);!1===soko?(addedBut=new THREE.Mesh(w,butMatA),addedDet=new THREE.Mesh(x,detMatA)):
...
doorClose.visible=!1):!1===soko&&(doorOpen.visible=!1,doorClose.visible=!0),optimX=Math.round(10*charX+offsetX),optimY=Math.round(-10*charY+offsetY),!0===toggles.anim&&!0===useWebGL?animate():(charMesh.position.y=optimY,charMesh.position.x=optimX,charMesh.rotation.z=charRot*Math.PI,render()))}}}var lastTime=0,requestAnimationFrame;
